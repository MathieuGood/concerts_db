  ...
  <div class="space-y-4">
    ...
    <template v-else>
      <div class="flex gap-2">
        <IconField class="flex-1"><InputIcon class="pi pi-search" /><InputText v-model="search" placeholder="Search people…" class="w-full" /><InputIcon v-if="search" class="pi pi-times cursor-pointer" style="pointer-events:auto" @click="search = ''" /></IconField>
