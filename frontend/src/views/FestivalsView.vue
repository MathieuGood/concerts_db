  ...
  <div>
    ...
    <template v-else>
      ...
      <DataTable :value="filtered" dataKey="id" sortField="events" :sortOrder="-1"
        ...
        <Column field="events" header="Days" sortable style="width:80px">
        ...
        <Column field="editions" header="Editions" sortable style="width:90px">
          <template #body="{ data }"><span :class="data.editions > 0 ? '' : 'text-gray-400'">{{ data.editions || '—' }}</span></template>
        </Column>
