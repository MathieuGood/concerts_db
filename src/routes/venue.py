...
@router.get("/venue/")
async def get_all_venues(db: Session = session):
    return get_all(db)


# Create venue
@router.post("/venue/")
async def create_venue(venue: VenueCreate, db: Session = session):
    return create(db, venue)


# Update venue
@router.put("/venue/{venue_id}")
async def update_venue(venue_id: int, venue: VenueCreate, db: Session = session):
    return update(db, venue_id, venue)


# Delete venue
@router.delete("/venue/{venue_id}")
async def delete_venue(venue_id: int, db: Session = session):
